# chatty OpenAPI Specification
[![Build Status](https://travis-ci.org/dalmasjunior/chatty-api.svg?branch=master)](https://travis-ci.org/dalmasjunior/chatty-api)
...
6. If you did everything correct, https://dalmasjunior.github.io/chatty-api/ will lead to your new docs
...
- Documentation(ReDoc): https://dalmasjunior.github.io/chatty-api/
- SwaggerUI: https://dalmasjunior.github.io/chatty-api/swagger-ui/
- Look full spec:
    + JSON https://dalmasjunior.github.io/chatty-api/swagger.json
    + YAML https://dalmasjunior.github.io/chatty-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://dalmasjunior.github.io/chatty-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://dalmasjunior.github.io/chatty-api/ with url from the message: `Server started <url>`
